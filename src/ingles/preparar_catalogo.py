...
def preparar_catalogo_ingles(extraida: Path, conceito_path: Path) -> pd.DataFrame:
    ...
    validar_unicidade_por_curso(conceitos, nome="conceitos de Letras–Inglês")
    ...
    cursos = aplicar_grupos_area(cursos, INGLES)
